...
/**
* @see \App\Http\Controllers\Quotation\Payable\PayableMessageController::index
* @see app/Http/Controllers/Quotation/Payable/PayableMessageController.php:30
* @route '/quotation-management/payable-partners/{partner}/messages'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/quotation-management/payable-partners/{partner}/messages',
...
/**
* @see \App\Http\Controllers\Quotation\Payable\PayableMessageController::store
* @see app/Http/Controllers/Quotation/Payable/PayableMessageController.php:40
* @route '/quotation-management/payable-partners/{partner}/messages'
*/
...
const PayableMessageController = { index, store }

export default PayableMessageController