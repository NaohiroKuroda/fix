...
use App\Http\Controllers\Quotation\Payable\AbstractPayableScreenController;
use App\Http\Requests\QuotationManagementRequest;
use App\Http\Resources\BillingPartnerResource;
use App\Services\Quotation\Billing\BillingQuotationService;
use Inertia\Inertia;
 ...
 * 支払系の {@see AbstractPayableScreenController} と同形。
 */
