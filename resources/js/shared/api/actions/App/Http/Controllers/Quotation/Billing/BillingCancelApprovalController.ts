...
/**
* @see \App\Http\Controllers\Quotation\Billing\BillingCancelApprovalController::index
...
* @see app/Http/Controllers/Quotation/Billing/BillingCancelApprovalController.php:38
...
const BillingCancelApprovalController = { index, confirm, reject }
